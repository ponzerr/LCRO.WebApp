        ...
        <h2 class="font-semibold text-3xl mb-6 text-gray-600 text-center">CERTIFICATE OF MARRIAGE</h2>
          ...
          <div class="grid grid-cols-1 space-y-6">
				<div class="lg:col-span-6">
              		<div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-6">
						<div class="md:col-span-6">
							<label for="mcert_file_registry_no" class="text-sm font-bold text-gray-500 tracking-wide">Registry No.</label>
							<h1 name="mcert_file_registry_no" id="mcert_file_registry_no" id="mcert_b_mothers_citizenship" class="h-10 border mt-1 rounded px-4 w-full bg-gray-100 flex items-center left-center text-base">
                                {{$mcertFile->mcert_file_registry_no}}</h1>
						</div>

						<div class="md:col-span-6">
							<label for="mcert_file_groom_name" class="text-sm font-bold text-gray-500 tracking-wide">Groom Name</label>
							<h1 name="mcert_file_groom_name" id="mcert_file_groom_name" id="mcert_b_mothers_citizenship" class="h-10 border mt-1 rounded px-4 w-full bg-gray-100 flex items-center left-center text-base">
                                {{$mcertFile->mcert_file_groom_name}}</h1>
						</div>

						<div class="md:col-span-6">
							<label for="mcert_file_bride_name" class="text-sm font-bold text-gray-500 tracking-wide">Bride Name</label>
							<h1 name="mcert_file_bride_name" id="mcert_file_bride_name" id="mcert_b_mothers_citizenship" class="h-10 border mt-1 rounded px-4 w-full bg-gray-100 flex items-center left-center text-base">
                                {{$mcertFile->mcert_file_bride_name}}</h1>
						</div>

                        <div class="md:col-span-6">
							<label for="mcert_file_attach_document" class="text-sm font-bold text-gray-500 tracking-wide">PDF File</label>
							<h1 name="mcert_file_attach_document" id="mcert_file_attach_document" class="h-10 border mt-1 rounded px-4 w-full bg-gray-100 flex items-center left-center text-base" value="" placeholder="">{{$mcertFile->mcert_file_attach_document}}</h1>
                        </div>
                ...
                <div class="flex justify-between mt-6">
                    <!-- Edit Button -->
                    <a href="{{ route('mcerts.edit_file', $mcertFile) }}">
